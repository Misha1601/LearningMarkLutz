...
Кроме того, использует множества, итераторы файлов и генераторы. что бы избежать
загрузки содержимого целиком, и пытается обойти проблемы, возникающие при
...
dirname, extname = os.curdir, '.py'     # поумолчанию файлы py в cwd
if len(argv) > 1: dirname = argv[1]     # например: С:\, С:\Python31\lib
