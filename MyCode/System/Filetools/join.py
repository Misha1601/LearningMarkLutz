...
"""
################################################################################
объединяет с все файлы фрагментов, имеющиеся в каталоге и созданные с помощью
сценарий split.py, воссоздавая первоначальный файл.
По своему действию этот суенарий напоминает команду 'cat fromdir/* >tofile'
