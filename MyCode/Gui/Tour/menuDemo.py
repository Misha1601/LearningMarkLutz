...
"""
Главнго меню окна в стиле Тк8.0
...
смотрите так же: add_checkbutton, add_radiobutton
"""
...
class NewMenuDemo(Frame):
    ...
    def createWidgets(self):
        self.makeMenuBar()
        self.makeToolBar()
        L = Label(self, text='Menu and ToolbarDemo')
    ...
    def notdone(self):
        showerror('Not implemented', 'Not yet availabel')
    def quit(self):
