...
def onLeftClick(event):
    print('Got left maus button click:', end=' ')
    showPosEvent(event)

def onRigthClick(event):
    print('Got rigth maus button click:', end=' ')
    showPosEvent(event)

def onMiddleClick(event):
    print('Got Middle maus button click', end=' ')
    showPosEvent(event)
    showAllEvent(event)

def onLeftDrag(event):
    print('Got left maus button drag:', end=' ')
    showPosEvent(event)
...
widget.bind('<Button-3>', onRigthClick)
